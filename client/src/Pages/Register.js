...
import VoteingImage from "./aa.png"
                ...
                <div className="card">
                    ...
                    <div className="fields">
                        <div className="field">
                            ...
                            <input placeholder="eg: Siddharth Mehta"/>
                        </div>
                        <div className="field">
                            <p className="label">Voter Id</p>
                            <input/>
                        </div>
                        <div className="field">
                            <p className="label">ETH Address</p>
                            <input value={VoterAddress} onChange={(e)=>setVoterAddress(e.target.value)} placeholder="eg: 0xD58ED7FfAdC5A09471eb5e8A175d421665994047"/>
                        </div>
                    </div>
                    <div className="button">
                        <p onClick={() => Add_Voter(VoterAddress)}>Add Voter</p>
                    </div>
                </div>
                <img className="votingImage" src={VoteingImage}/>
            </div>
            <p className="quote">“Someone struggled for your right to vote. Use it.”</p>
        </div>
    )
}
